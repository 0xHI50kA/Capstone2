            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="dashboard.php"><i class="fa fa-calendar"></i> <span>Update Event Calendar</span></a>
                        </li>
                        <li>
                            <a href="dashboardnews.php"><i class="fa fa-newspaper"></i></i><span>Update news</span></a>
                        </li>
