								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Total Subscribers</h2>
...
{
?>
											Total Subscribers :<?php echo htmlentities($num_rows);  } ?>		
												</a>
											</p>
										</div>
									</div>
...
?>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </i></span>
											<h2 class="StepTitle">Nurses</h2>
...
{
?>
											Total Nurses :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
...
<div class="col-sm-4">
									<!-- <div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Total Patient Visit</h2>
...
{
?>
Total Visitors :<?php echo htmlentities($num_rows);  
} ?>		
</a>
											</p>
										</div>
